...
public class ShareActivityTest {
    @Rule
    public final ActivityRule<TestableShareActivity> rule = new ActivityRule<TestableShareActivity>(TestableShareActivity.class) {
        @Override protected Intent getLaunchIntent(String targetPackage, Class<TestableShareActivity> activityClass) {
